...
<div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <table class="table">
	   ...
	   <th class="cell100 column5" style="text-align:center">lec_ID</th>
       <th class="cell100 column5" style="text-align:center">name</th>
       <th class="cell100 column2" style="text-align:center">inst_ID</th>
       <th class="cell100 column4" style="text-align:right">hall</th>
       <th class="cell100 column1" style="text-align:right">days</th>
       <th class="cell100 column5" style="text-align:right">lec_start_time</th>
       <th class="cell100 column5" style="text-align:right">lec_end_time</th>
       <th class="cell100 column5" style="text-align:center">log_start_time</th>
       <th class="cell100 column5" style="text-align:center">log_end_time</th>
       <th>Modfiy</th>
								</tr>
							</thead>
						</table>
...
$result = mysqli_query($con,$sql_query);
  ...
  if ($result->num_rows > 0) {
   ...
   while($row = $result->fetch_assoc()) {
	...
	<td class='cell100 column5' style='text-align:left'>" . $row["lec_ID"]. "</td>
	<td class='cell100 column2' style='text-align:left'>" . $row["name"] . "</td>
	<td class='cell100 column1' style='text-align:left'>" . $row["inst_ID"] . "</td>
	<td class='cell100 column4' style='text-align:left'>" . $row["hall"] . "</td>
	<td class='cell100 column1' style='text-align:left'>" . $row["days"] . "</td>
	<td class='cell100 column1' style='text-align:left'>" . $row["lec_start_time"] . "</td>
	<td class='cell100 column1' style='text-align:left'>" . $row["lec_end_time"] . "</td>
	<td class='cell100 column1' style='text-align:left'>" . $row["log_start_time"] . "</td>
	<td class='cell100 column1' style='text-align:left'>" . $row["log_end_time"] . "</td>
	<td class='cell100 column5' style='text-align:left'><a href=delete.php?id=" .$row["lec_ID"].">Delete</a></td>
		<td class='cell100 column5' style='text-align:left'><a href=edit_data.php?id=" .$row["lec_ID"].">Update</a></td>
...
<!--===============================================================================================-->
    ...
    $.ajax({
        ...
        data:$("#updateForm").serialize(),
            success:function(data){
               alert('1 Rrecord Update Successful');
