...
## Project Description
Co-pilot is an Android Application with a web service that uses an NFC connection with Raspberry-pi 3 to control the Accesses without using E-cards. You __need__ <em>Raspberry-pi 3 to test the connection only.</em>

Languages & Tools: Kotlin, Python3, PHP, HTML, CSS, JavaScript, Java, and XML, Data Modeling, Artificial Intelligence-AI and Raspberry-Pi3.
